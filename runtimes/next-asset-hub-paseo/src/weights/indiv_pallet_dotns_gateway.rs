...
//! HOSTNAME: `parity-weights-513972198bdbaab9`, CPU: `Intel(R) Xeon(R) CPU @ 2.60GHz`
...
impl<T: frame_system::Config> indiv_pallet_dotns_gateway::WeightInfo for WeightInfo<T> {
	...
	fn reserve_name() -> Weight {
		...
		Weight::from_parts(113_784_000, 0)
	...
	fn register_name() -> Weight {
		...
		Weight::from_parts(42_474_000, 0)
			.saturating_add(Weight::from_parts(0, 3712))
	...
	fn as_register_full_name_tx_ext() -> Weight {
		...
		//  Measured:  `1605`
		//  Estimated: `4470`
		// Minimum execution time: 17_755_626_000 picoseconds.
		Weight::from_parts(17_964_705_000, 0)
