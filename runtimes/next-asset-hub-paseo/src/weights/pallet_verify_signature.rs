...
// Executed Command:
// /tmp/issue87-frame-omni-bencher
// v1
// benchmark
// pallet
// --extrinsic=*
// --runtime=target/production/wbuild/next-asset-hub-paseo-runtime/next_asset_hub_paseo_runtime.wasm
// --pallets=pallet_verify_signature
// --header=/Users/theo/Projects/parity/individuality-community/.github/scripts/cmd/file_header.txt
// --output=/tmp/issue87-asset-hub-pallet_verify_signature.rs
