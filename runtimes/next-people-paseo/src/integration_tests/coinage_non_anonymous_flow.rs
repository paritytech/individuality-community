...
fn build_unload_fee_from_output_ext(
	...
	let rest_ext_for_implication = (
		(tx_ext.0 .0 .9.clone(), tx_ext.0 .0 .10.clone()),
		tx_ext.0 .1.clone(),
		tx_ext.0 .2.clone(),
		tx_ext.0 .3.clone(),
		tx_ext.0 .4.clone(),
	...
	// 4. Update the extension (Index 0.0.7)
	tx_ext.0 .0 .8 = indiv_pallet_coinage::extension::AsCoinage::<Runtime>::new(Some(info));
