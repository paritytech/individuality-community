...
impl<T: frame_system::Config> indiv_pallet_nft_credits::WeightInfo for WeightInfo<T> {
	...
	/// Proof: `NftCredits::AwardExpiries` (`max_values`: None, `max_size`: Some(24), added: 2499, mode: `MaxEncodedLen`)
	/// Storage: `NftCredits::NftClaimCreditAwards` (r:0 w:32)
	/// Proof: `NftCredits::NftClaimCreditAwards` (`max_values`: None, `max_size`: Some(78014), added: 80489, mode: `MaxEncodedLen`)
	/// Storage: `NftCredits::NextAwardExpiryBucket` (r:0 w:1)
	/// Proof: `NftCredits::NextAwardExpiryBucket` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `MaxEncodedLen`)
	/// The range of component `n` is `[0, 32]`.
	fn sweep_expired_awards(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		//  Estimated: `3000 + n * (82988 ±0)`
		Weight::from_parts(8_000_000, 0)
			.saturating_add(Weight::from_parts(0, 3000))
			// Standard Error: 6_000
			.saturating_add(Weight::from_parts(2_500_000, 0).saturating_mul(n.into()))
			...
			.saturating_add(T::DbWeight::get().writes(1))
			.saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(n.into())))
			.saturating_add(Weight::from_parts(0, 82988).saturating_mul(n.into()))
	}
	/// Storage: `NftCredits::NextAwardExpiryBucket` (r:1 w:0)
	/// Proof: `NftCredits::NextAwardExpiryBucket` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `MaxEncodedLen`)
